"""
generate_post.py
Generates LinkedIn and Facebook posts in the user's voice using OpenAI.
...
def generate_summary(article: dict) -> str:
    ...
    response = client.responses.create(
        model=SUMMARY_MODEL,
        input=f"""Summarize this article in 3-4 sentences for a B2B SaaS and AI marketer.
...
Your job is to translate their raw opinion — which may be bullet points or rough prose — into a polished post that sounds exactly like them.
